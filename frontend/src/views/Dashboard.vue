  ...
  <div class="space-y-6">
    ...
    <div class="card">
      <div class="p-4 border-b border-gray-200 flex items-center justify-between">
        ...
        <router-link to="/cameras" class="text-sm text-primary-600 hover:text-primary-500">
          View All
        </router-link>
      </div>
      <div class="p-4">
        ...
        <div v-else-if="camerasStore.cameras.length === 0" class="text-center py-8 text-gray-500">
          No cameras configured. <router-link to="/cameras" class="text-primary-600">Add one</router-link>
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
      ...
      <div class="card">
        <div class="p-4 border-b border-gray-200">
          <h2 class="text-lg font-semibold text-gray-900">Recent Timelapses</h2>
        </div>
        <div class="p-4">
          <div v-if="recentTimelapses.length === 0" class="text-center py-4 text-gray-500">
            No timelapses yet
          </div>
          <ul v-else class="space-y-3">
            ...
            >
              <div>
                <p class="text-sm font-medium text-gray-900">{{ timelapse.camera_name }}</p>
                <p class="text-xs text-gray-500">{{ formatDate(timelapse.date_start) }}</p>
              </div>
